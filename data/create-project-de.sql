...
Das Team des ePartool'
    ...
    (
        ...
        '<p>Hallo {{to_name}},</p>
<p>bitte best&auml;tige, dass du k&uuml;nftig &uuml;ber neue Reaktionen und Wirkungen zu &bdquo;{{consultation_title_long}}&ldquo; automatisch benachrichtigt werden willst. Klicke hierf&uuml;r auf folgenden Best&auml;tigungslink:<br />
<a href="{{confirmation_url}}">{{confirmation_url}}</a></p>
<p>Viele Gr&uuml;&szlig;e<br />
Das Team des ePartool</p>',
        'Hallo {{to_name}},
    ...
    (
        ...
        '<p>Hallo {{to_name}},</p>
<p>bitte best&auml;tige deine Registrierung als neue_r Empf&auml;nger_in f&uuml;r automatische Benachrichtigungen bei neuen Reaktionen zu &bdquo;{{consultation_title_long}}&ldquo; und den dazugeh&ouml;rigen Nutzeraccount. Klicke hierf&uuml;r auf folgenden Best&auml;tigungslink:<br />
<a href="{{confirmation_url}}">{{confirmation_url}}</a></p>
<p>Viele Gr&uuml;&szlig;e<br />
Das Team des ePartool</p>',
        'Hallo {{to_name}},
