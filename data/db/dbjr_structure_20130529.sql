...
CHECKSUM=1 AUTO_INCREMENT=119 AVG_ROW_LENGTH=7508 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
COMMENT=''
;
...
CREATE TABLE `articles_refnm` (
  ...
  `scope` ENUM('none','info','voting','followup','static') COLLATE utf8_unicode_ci DEFAULT 'none' COMMENT 'none, info, voting, followup, static',
...
CHECKSUM=1 AUTO_INCREMENT=11 AVG_ROW_LENGTH=1664 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
...
CREATE TABLE `discuss` (
  ...
  `tmphash` CHAR(32) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY USING BTREE (`tid`, `uid`, `tmphash`)
)ENGINE=MyISAM
AVG_ROW_LENGTH=104 ROW_FORMAT=FIXED CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
...
CREATE TABLE `discussns` (
  ...
  `inpt` VARCHAR(6000) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Actual text',
...
AUTO_INCREMENT=15 AVG_ROW_LENGTH=174 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
...
CREATE TABLE `fowups` (
  ...
  `rid` VARCHAR(100) COLLATE utf8_unicode_ci NOT NULL COMMENT 'reference to TID/FID/FFID [Txx|Fxx|Dxx:linktyp]',
  `docorg` SMALLINT(5) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'internal order of document',
  `embed` VARCHAR(600) COLLATE utf8_unicode_ci NOT NULL COMMENT 'embedding for multimedia',
  `expl` VARCHAR(10000) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Erläuterung',
...
CHECKSUM=1 AUTO_INCREMENT=3422 AVG_ROW_LENGTH=229 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
...
CHECKSUM=1 AUTO_INCREMENT=16 AVG_ROW_LENGTH=980 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
...
AUTO_INCREMENT=231 AVG_ROW_LENGTH=143 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
...
AVG_ROW_LENGTH=166 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
...
CHECKSUM=1 AVG_ROW_LENGTH=986 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
...
CHECKSUM=1 AVG_ROW_LENGTH=150 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
...
AUTO_INCREMENT=464 AVG_ROW_LENGTH=24 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
...
AVG_ROW_LENGTH=8 ROW_FORMAT=FIXED CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
COMMENT=''
;
...
CREATE TABLE `user_info` (
  `user_info_id` INTEGER(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'User Info ID',
  `uid` MEDIUMINT(8) UNSIGNED NOT NULL COMMENT 'User ID',
  `kid` SMALLINT(5) UNSIGNED NOT NULL COMMENT 'Consultation ID',
  `ip` CHAR(15) COLLATE latin1_general_ci NOT NULL DEFAULT '' COMMENT 'IP Address User',
  ...
  PRIMARY KEY USING BTREE (`user_info_id`)
)ENGINE=MyISAM
CHECKSUM=1 AUTO_INCREMENT=5 AVG_ROW_LENGTH=148 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
COMMENT='User info'
;
...
CHECKSUM=1 AUTO_INCREMENT=99052 AVG_ROW_LENGTH=157 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
COMMENT='Users in the system'
;
...
CREATE TABLE `vt_grps` (
  ...
  `sub_user` VARCHAR(60) COLLATE utf8_unicode_ci NOT NULL COMMENT 'email address',
  `sub_uid` CHAR(32) COLLATE utf8_unicode_ci NOT NULL COMMENT 'md5 of mail.kid',
  `kid` SMALLINT(5) UNSIGNED NOT NULL COMMENT 'rel KID',
...
CHECKSUM=1 AVG_ROW_LENGTH=2271 CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci'
...
CREATE TABLE `vt_indiv` (
  ...
  `sub_uid` CHAR(32) COLLATE utf8_unicode_ci NOT NULL COMMENT 'individual subuser',
  ...
  `upd` TIMESTAMP NOT NULL ON UPDATE CURRENT_TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT 'when vote was cast',
...
CREATE TABLE `vt_rights` (
  ...
  `vt_code` CHAR(8) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Voting access code for this group',
