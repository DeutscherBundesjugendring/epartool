...
ALTER TABLE `inpt` CHANGE `type` `type` varchar(191) NULL, ADD FOREIGN KEY (`type`) REFERENCES `contribution_type` (`name`) ON DELETE RESTRICT;
...
ALTER TABLE `articles` CHANGE `artcl` `artcl` text NOT NULL DEFAULT '' COMMENT 'Article itself';
...
ALTER TABLE `articles` CHANGE `sidebar` `sidebar` text NOT NULL DEFAULT '' COMMENT 'Content for sidebar';
...
ALTER TABLE `cnslt` CHANGE `contribution_confirmation_info` `contribution_confirmation_info` text NOT NULL DEFAULT '' COMMENT '';
ALTER TABLE `cnslt` CHANGE `expl_short` `expl_short` text NOT NULL DEFAULT '' COMMENT '';
ALTER TABLE `cnslt` CHANGE `follow_up_explanation` `follow_up_explanation` text NULL DEFAULT '' COMMENT '';
ALTER TABLE `cnslt` CHANGE `img_expl` `img_expl` varchar(255) NOT NULL DEFAULT '' COMMENT 'explanatory text for title graphics';
ALTER TABLE `cnslt` CHANGE `img_file` `img_file` text NULL DEFAULT '' COMMENT '';
ALTER TABLE `cnslt` CHANGE `license_agreement` `license_agreement` text NULL DEFAULT '' COMMENT '';
...
ALTER TABLE `cnslt` CHANGE `vot_expl` `vot_expl` text NOT NULL DEFAULT '' COMMENT 'info text for voting start';
ALTER TABLE `dirs` CHANGE `dir_name` `dir_name` varchar(255) NOT NULL DEFAULT '' COMMENT '';
ALTER TABLE `email` CHANGE `body_html` `body_html` text NULL DEFAULT '' COMMENT '';
ALTER TABLE `email` CHANGE `body_text` `body_text` text NULL DEFAULT '' COMMENT '';
...
ALTER TABLE `email_component` CHANGE `body_html` `body_html` text NOT NULL DEFAULT '' COMMENT '';
ALTER TABLE `email_component` CHANGE `body_text` `body_text` text NOT NULL DEFAULT '' COMMENT '';
ALTER TABLE `email_component` CHANGE `description` `description` text NOT NULL DEFAULT '' COMMENT '';
...
ALTER TABLE `email_placeholder` CHANGE `description` `description` text NULL DEFAULT '' COMMENT '';
...
ALTER TABLE `email_template` CHANGE `body_html` `body_html` text NOT NULL DEFAULT '' COMMENT '';
ALTER TABLE `email_template` CHANGE `body_text` `body_text` text NOT NULL DEFAULT '' COMMENT '';
...
ALTER TABLE `footer` CHANGE `text` `text` text NULL DEFAULT '' COMMENT '';
ALTER TABLE `fowups` CHANGE `embed` `embed` varchar(600) NOT NULL DEFAULT '' COMMENT 'embedding for multimedia';
ALTER TABLE `fowups` CHANGE `expl` `expl` text NOT NULL DEFAULT '' COMMENT 'Erläuterung';
...
ALTER TABLE `help_text` CHANGE `body` `body` text NULL DEFAULT '' COMMENT '';
...
ALTER TABLE `input_discussion` CHANGE `body` `body` text NULL DEFAULT '' COMMENT '';
...
ALTER TABLE `license` CHANGE `text` `text` text NOT NULL DEFAULT '' COMMENT '';
...
ALTER TABLE `notification_parameter` CHANGE `value` `value` text NULL DEFAULT '' COMMENT '';
...
ALTER TABLE `parameter` CHANGE `value` `value` text NULL DEFAULT '' COMMENT '';
...
ALTER TABLE `quests` CHANGE `q_xpl` `q_xpl` text NOT NULL DEFAULT '' COMMENT 'Explanation for question';
...
ALTER TABLE `urlkey_action_parameter` CHANGE `value` `value` text NULL DEFAULT '' COMMENT '';
...
ALTER TABLE `vt_grps` CHANGE `vt_inp_list` `vt_inp_list` text NOT NULL DEFAULT '' COMMENT 'list of votable tids';
ALTER TABLE `vt_grps` CHANGE `vt_rel_qid` `vt_rel_qid` text NOT NULL DEFAULT '' COMMENT 'list of rel QIDs';
ALTER TABLE `vt_grps` CHANGE `vt_tg_list` `vt_tg_list` text NOT NULL DEFAULT '' COMMENT 'list of all (still) available tags for this user';
