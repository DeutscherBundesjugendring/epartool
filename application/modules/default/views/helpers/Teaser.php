...
class Zend_View_Helper_Teaser extends Zend_View_Helper_Abstract
{
    public function teaser()
    {
        ...
        foreach ($items as $item) {
            ...
            switch ($item['relevantField']) {
                case 'inp_fr':
                    ...
                    $text = $this->view->translate('Jetzt kannst du deinen Beitrag einstellen!')
                    . $this->view->translate('Vom') . ' '
                ...
                case 'inp_to':
                    ...
                    $text = $this->view->translate('Die Beitragsphase ist vorbei! Demnächst kann abgestimmt werden:')
                    . $this->view->translate('vom') . ' '
                ...
                case 'vot_fr':
                    ...
                    $text = $this->view->translate('Jetzt ist Abstimmen über die wichtigsten Beiträge angesagt!') . ' …';
                    break;
                case 'vot_to':
                    $url = $this->view->url(array(
                        'controller' => 'input',
                    ...
                    $text = $this->view->translate('Die Abstimmungsphase ist vorbei! Demnächst wird es Reaktionen geben') . ' …';
                    break;
                default:
                    $url = $this->view->url(array(
                        'controller' => 'article',
                    ...
                    $text = $this->view->translate('Jetzt informieren') . ' …';
            }
        ...
        $html.= '<li><a href="' . $this->view->url(array(
            ...
            . '<strong>' . $this->view->translate('Auf der Suche nach einer anderen Beteiligungsrunde? Alle in der Übersicht ansehen') . ' …</strong>'
            . '<i class="icon-angle-right icon-white icon-2x"></i>'
            . '</a></li>';
