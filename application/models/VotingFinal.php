...
class Model_VotingFinal extends Dbjr_Db_Table_Abstract
{
	...
	**/
	...
	/**
	* getFinalVotesByQuestion
	* get all final Votes by a question
	...
	**/
	...
	/**
	 * updateFinalVotePlace
	 * update the final votes with his place
	 * @see CloseController|admin: writeResultsFinishAction() ;
	 * @param array $data
	 * @return array
	 */
